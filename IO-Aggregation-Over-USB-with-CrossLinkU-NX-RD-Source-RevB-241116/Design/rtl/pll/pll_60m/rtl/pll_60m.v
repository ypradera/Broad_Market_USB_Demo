...
*******************************************************************************/
module pll_60m (clki_i, 
        clkop_o, 
        lock_o) ;
    input clki_i ; 
    output clkop_o ; 
    output lock_o ; 
    pll_60m_ipgen_lscc_pll #(.INTFBKDEL_SEL("DISABLED"),
            ...
            .FRAC_N_EN(1),
            .FBK_MODE("INTCLKOP"),
            .FBCLK_DIVIDER_ACTUAL_STR("60"),
            .SSC_N_CODE_STR("0b000111100"),
...
// Module : lscc_pll
//==========================================================================
module pll_60m_ipgen_lscc_pll #(parameter FVCO = 800.0, 
    ...
    generate
        if ((APB_EN == 1)) 
            begin : APB2LMMI_INST
                ...
                ///
                pll_60m_ipgen_lscc_apb2lmmi #(.DATA_WIDTH(8),
                        .ADDR_WIDTH(7),
...
//==========================================================================
module pll_60m_ipgen_lscc_apb2lmmi #(parameter DATA_WIDTH = 32, 
