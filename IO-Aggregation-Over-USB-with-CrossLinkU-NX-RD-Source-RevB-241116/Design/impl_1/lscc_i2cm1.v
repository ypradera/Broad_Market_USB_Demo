...
// Netlist written on Wed Nov  6 22:11:15 2024
...
//
// Verilog Description of module lscc_i2cm1
...
module lscc_i2cm1 (scl_io, sda_io, clk_i, rst_n_i, int_o, apb_penable_i, 
            ...
            apb_pslverr_o, apb_prdata_o) /* synthesis ORIG_MODULE_NAME="lscc_i2cm1", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    inout scl_io;
    inout sda_io;
    input clk_i;
    input rst_n_i;
