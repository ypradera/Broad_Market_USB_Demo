...
// Netlist written on Wed Nov  6 22:10:58 2024
...
module ahbl2apb0 (clk_i, rst_n_i, ahbl_hsel_i, ahbl_hready_i, ahbl_haddr_i, 
            ahbl_hburst_i, ahbl_hsize_i, ahbl_hmastlock_i, ahbl_hprot_i, 
            ahbl_htrans_i, ahbl_hwdata_i, ahbl_hwrite_i, ahbl_hreadyout_o, 
            ahbl_hresp_o, ahbl_hrdata_o, apb_pready_i, apb_pslverr_i, 
            apb_prdata_i, apb_psel_o, apb_paddr_o, apb_pwrite_o, apb_pwdata_o, 
            apb_penable_o) /* synthesis ORIG_MODULE_NAME="ahbl2apb0", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    input clk_i;
    input rst_n_i;
    input ahbl_hsel_i;
    input ahbl_hready_i;
